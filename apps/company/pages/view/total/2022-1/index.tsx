    ...
    useEffect(() => {
        if (data) {
            ...
            for (let i = 0; i < 4; i++) {
                ...
                for (let j = 0; j < 20; j++) {
                    const number = j + 1 + '';
                    const tempgcn = '1' + (i + 1) + '' + number.padStart(2, '0');
    ...
    const getOtherPage = () => {
        ...
        switch (true) {
            ...
            case curPage > 3 && curPage <= 23: {
                return (
                    <EmptyPage>
                        <h1>{'11' + (curPage - 3 + '').padStart(2, '0')}</h1>
                        <h2>No Data</h2>
                    </EmptyPage>
                );
            }
            ...
            case curPage > 24 && curPage <= 44: {
                return (
                    <EmptyPage>
                        <h1>{'12' + (curPage - 24 + '').padStart(2, '0')}</h1>
                        <h2>No Data</h2>
                    </EmptyPage>
                );
            }
            ...
            case curPage > 45 && curPage <= 65: {
                return (
                    <EmptyPage>
                        <h1>{'13' + (curPage - 45 + '').padStart(2, '0')}</h1>
                        <h2>No Data</h2>
                    </EmptyPage>
                );
            }
            ...
            case curPage > 66 && curPage <= 86: {
                return (
                    <EmptyPage>
                        <h1>{'14' + (curPage - 66 + '').padStart(2, '0')}</h1>
                        <h2>No Data</h2>
                    </EmptyPage>
                );
            }
